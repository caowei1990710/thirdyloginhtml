(function () {
  ...
  function thirdyAccountController($scope, $timeout, jQ, httpRequest, $rootScope, $state, loc_language_cn) {
    var vm = this;
    vm.createBankForm = {"type": "1", "creatUser": $rootScope.user.name, "hightlimit": "50000"};
    vm.editBankForm = {};
    vm.thirdyaccount = {};
    vm.totalSum = 0;
    vm.sizePerPage = 500;
    ...
    vm.createresult = function (data) {
      ...
      if (data.code == 200) {
        ...
        formData.append("fileName", vm.editBankForm.wechatName.replace(".", "") + ".jpg");
        $.ajax({
          url: 'http://api.wandapay88.com/',
          type: 'post',
          data: formData,
          processData: false,
          contentType: false,
    ...
    vm.editBank = function (index) {
      ...
      // else
      vm.editBankForm.img = window.imgurl + "" + vm.editBankForm.wechatName.replace(".", "") + ".jpg";
    }
