(function () {
  ...
  function routerConfig($stateProvider, $urlRouterProvider) {
    $stateProvider
      ...
      .state('forthlogin', {
        url: '/forthlogin',
        templateUrl: 'app/forthlogin/forthlogin.html',
        controller: 'forthLoginController',
        controllerAs: 'forthlogin'
      })
      .state('forthloginhome', {
        url: '/forthloginhome',
        templateUrl: 'app/forthloginhome/forthloginhome.html',
        controller: 'forthloginHomeController',
        controllerAs: 'forthloginhome'
      })
      .state('forthloginhome.merchatlist', {
        url: '/merchatlist',
        views: {
          'content': {
            templateUrl: 'app/forthmerchatlist/forthmerchatlist.html',
            controller: 'forthmerchatlistController',
            controllerAs: 'forthmerchatlist'
          }
        }
      })
      .state('forthloginhome.forthproposallist', {
        url: '/forthproposallist',
        views: {
          'content': {
            templateUrl: 'app/forthproposallist/forthproposallist.html',
            controller: 'forthproposallistController',
            controllerAs: 'forthproposallist'
          }
        }
      })
      .state('forthloginhome.forthuserlist', {
        url: '/forthuserlist',
        views: {
          'content': {
            templateUrl: 'app/forthuserlist/forthuserlist.html',
            controller: 'forthuserlistController',
            controllerAs: 'forthuserlist'
          }
        }
      })
      .state('forthloginhome.forthaccount', {
        url: '/forthaccount',
        views: {
          'content': {
            templateUrl: 'app/forthaccountlist/forthaccountlist.html',
            controller: 'forthaccountlistController',
            controllerAs: 'forthaccountlist'
          }
        }
      })
      .state('test', {
...
// $urlRouterProvider.otherwise('/shunpaylogin');
    $urlRouterProvider.otherwise('/forthlogin');
